 ...
 * @author ASUS
 */
public class LoginPemerintah extends javax.swing.JFrame {

    /**
     * Creates new form LoginPemerintah
     */
    public LoginPemerintah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Masuk Pemerintah");
    ...
    private void Btn_masukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_masukActionPerformed
         try {
            sql = "SELECT * FROM pemerintah WHERE username='"+LoginAdmin.txt_name.getText()+"' AND password='"+txt_pass.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginPemerintah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginPemerintah().setVisible(true);
            }
        });
    }
